...
typedef LRESULT( CALLBACK* WindowCallbackProc )( HWND, UINT, WPARAM, LPARAM );
...
BOOL CreateEntityWindow(HINSTANCE hInstance)
{
	...
	OldFieldWindowProc = (WindowCallbackProc)GetWindowLong (hwndEnt[EntKeyField], GWL_WNDPROC);
	...
	OldEntityListWindowProc = (WindowCallbackProc)GetWindowLong (hwndEnt[EntList], GWL_WNDPROC);
