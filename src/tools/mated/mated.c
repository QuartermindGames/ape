...
static void ActivateApp( GApplication *app, gpointer *data )
{
	...
	gtk_window_set_title( GTK_WINDOW( mainWindow ), "APE Material Editor" );
...
{
	GtkApplication *app = gtk_application_new( "com.ape.material_editor", G_APPLICATION_DEFAULT_FLAGS );
