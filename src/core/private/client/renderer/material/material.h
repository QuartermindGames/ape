...
{
	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_FOG_COLOUR,
	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_FOG_NEAR,
	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_FOG_FAR,

	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_LIGHT_COLOUR,
	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_LIGHT_POSITION,
	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_LIGHT_RADIUS,

	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_SUN_COLOUR,
	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_SUN_POSITION,

	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_AMBIENCE,

	APE_SHADER_PROGRAM_GLOBAL_UNIFORM_TEXTURE_OFFSET,

	APE_SHADER_PROGRAM_MAX_GLOBAL_UNIFORMS
...
typedef struct ApeShaderProgram
{
	...
	int globalUniforms[ APE_SHADER_PROGRAM_MAX_GLOBAL_UNIFORMS ];
