...
The following are specific to the _cook_ utility and are not supported by the engine directly.
Typically, you shouldn't need to worry about these as they'll be generated by the tools.
