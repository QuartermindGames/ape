...
**Copyright (C) 2020-2024 Mark E Sowden <[hogsy@oldtimes-software.com](mailto:hogsy@oldtimes-software.com)>**
...
The binary format isn't as efficient as I'd like, but it currently works like so...
...
The only difference here for now is that it features a version indicator.
...
I should add that formatting-wise, there are very few explicit rules.
You can technically do the following if you really wanted to, to give you an idea...
